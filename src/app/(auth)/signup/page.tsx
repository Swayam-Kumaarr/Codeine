...
export default function SignupPage() {
  ...
  return (
    <div style={{ width: '100%', maxWidth: '400px' }}>
      ...
      <p style={{ marginTop: '32px', fontSize: '13px', color: 'var(--ink-2)', textAlign: 'center' }}>
        Already have an account?{' '}
        <Link href="/login" style={{ color: 'var(--ink)', fontWeight: 500, textDecoration: 'none', borderBottom: '1px solid var(--ink)' }}>
          Sign in
        </Link>
      </p>
    </div>
